...
class plgVmPaymentEvopayments extends vmPSPlugin
{
    ...
    const ST_EVO_CASHIER_URL_SANDBOX = "https://cashierui-apiuat.test.evopaymentgateway.com/ui/cashier";
    const ST_EVO_JAVASCRIPT_URL_SANDBOX = "https://cashierui-apiuat.test.evopaymentgateway.com/js/api.js";
    const ST_EVO_TOKEN_URL_SANDBOX = "https://apiuat.test.evopaymentgateway.com/token";
    const ST_EVO_PAYMENT_URL_SANDBOX = "https://apiuat.test.evopaymentgateway.com/payments";
   
    const ST_EVO_CASHIER_URL_LIVE = "https://cashierui-api.evopaymentgateway.com/ui/cashier";
    const ST_EVO_JAVASCRIPT_URL_LIVE = "https://cashierui-api.evopaymentgateway.com/js/api.js";
    const ST_EVO_TOKEN_URL_LIVE = "https://api.evopaymentgateway.com/token";
    const ST_EVO_PAYMENT_URL_LIVE = "https://api.evopaymentgateway.com/payments";
    //DEFAULT TO IFRAME
    // 1 - IFRAME
    // 0 - REDIRECT
    // 2 - HOSTED PAY
